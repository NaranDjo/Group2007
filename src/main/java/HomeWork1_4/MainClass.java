...
import java.util.Scanner;
    public class MainClass {
        ...
        public static boolean checkWin(char symb) {
            ...
            if (map[2][0] == symb && map[2][1] == symb && map[2][2] == symb && map[2][3]==symb) return true;
            if (map[3][0] == symb && map[3][1] == symb && map[3][2] == symb && map[3][3]==symb) return true;
            ...
            if (map[0][2] == symb && map[1][2] == symb && map[2][2] == symb && map[3][2]==symb) return true;
